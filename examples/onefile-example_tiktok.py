...
from tsup.utils.webdriver.saveCookie import getCookieWithProxy

profilepath = (
    r"D:\Download\audio-visual\make-text-video\reddit-to-video\assets\profile\fastlane"
)
CHANNEL_COOKIES = r"D:\Download\audio-visual\saas\tiktoka\ytb-up\fastlane-cookie.json"
CHANNEL_COOKIES = ""
# CHANNEL_COOKIES = r"D:\Download\audio-visual\saas\tiktoka\ytb-up\cutt.json"
...
upload = TiktokUpload(
    ...
    username=username,
    password=password,
    closewhen100percent=closewhen100percent,
    recordvideo=True
    # for test purpose we need to check the video step by step ,
)


# first time you can use this to gen cookie for later load
CHANNEL_COOKIES = asyncio.run(getCookieWithProxy(upload))
print("autogen cookie file is:", CHANNEL_COOKIES)
today = date.today()
