...
ITEM_PIPELINES = [
    "upgenius.pipelines.mysql_pipeline.MysqlPipeline",
    # "upgenius.pipelines.mongo_pipeline.MongoPipeline",
    # "upgenius.pipelines.console_pipeline.ConsolePipeline",
]
...
# 下载
DOWNLOADER = "upgenius.network.downloader.RequestsDownloader"
SESSION_DOWNLOADER = "upgenius.network.downloader.RequestsSessionDownloader"
RENDER_DOWNLOADER = "upgenius.network.downloader.SeleniumDownloader"
# RENDER_DOWNLOADER="upgenius.network.downloader.PlaywrightDownloader"
